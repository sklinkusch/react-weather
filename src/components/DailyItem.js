  ...
  return (
    <div className="col-md-4">
      ...
      <ul>
        ...
        <li>
          maximum: {getCelsius(props.data.temperatureMax)} (feels like:{" "}
          {getCelsius(props.data.apparentTemperatureMax)})
        </li>
        <li>
          minimum: {getCelsius(props.data.temperatureMin)} (feels like:{" "}
          {getCelsius(props.data.apparentTemperatureMin)})
        </li>
        ...
        <li>
          precipitation: {(24 * props.data.precipIntensity).toFixed(2)} mm/d
        </li>
        ...
        <li>
          wind: {getDirection(props.data.windBearing)}{" "}
          {getBeaufort(props.data.windSpeed)} (gusts:{" "}
          {getBeaufort(props.data.windGust)})
        </li>
        <li>relative humidity: {getPercent(props.data.humidity)}</li>
        <li>dew point: {getCelsius(props.data.dewPoint)}</li>
