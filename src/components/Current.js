        ...
        {context => (
          <div className="jumbotron">
            <div className="container sk-flex-row">
                ...
                <ul>
                  {"currently" in context.weatherData && (
                    <>
                      ...
                      <li>cloud cover: {getPercent(context.weatherData.currently.cloudCover)}</li>
                      <li>precipitation probability: {getPercent(context.weatherData.currently.precipProbability)}</li>
                      <li>air pressure: {context.weatherData.currently.pressure} mbar</li>
                      <li>wind: {getDirection(context.weatherData.currently.windBearing)} {getBeaufort(context.weatherData.currently.windSpeed)} (gusts: {getBeaufort(context.weatherData.currently.windGust)})</li>
                      <li>relative humidity: {getPercent(context.weatherData.currently.humidity)}</li>
              ...
              {"currently" in context.weatherData && <CurrentImage icon={context.weatherData.currently.icon} />}
            </div>
          </div>
        )}
      </AppContext.Consumer>
